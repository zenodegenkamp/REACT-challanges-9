...
---------------Write your code for task 1 below.------------------------------------------------*/  
			...
			// Change current Calculation number array to numbers inserted by user
			  setCurrentCalc(oldObject => ({
				  ...oldObject,
				  currentNum: [...oldObject.currentNum, numFromClick],
			  }))
...
---------------Write your code for task 3 below.------------------------------------------------*/
			  ...
			  setCurrentCalc(oldObject => ({
				  ...oldObject,
				  result: [], // leegmaken van result
				  previousNum: oldObject.result, // toewijzen van oude result aan previousNum
				  currentNum: [numFromClick],
